...
export class ProductsController {
  ...
  @ApiResponse({ status: 400, description: 'El id del producto no contiene el formato correcto de UUID.' })
  @ApiResponse({ status: 404, description: 'El producto con ese id no existe.' })
  ...
  @ApiResponse({ status: 400, description: 'El producto ya existe en la base de datos.' })
  ...
  @Delete(':id')
  @UseGuards(AuthGuard)
  @ApiResponse({ status: 200, description: 'El producto con el id fue borrado con exito.' })
  @ApiResponse({ status: 400, description: 'El id del producto no contiene el formato correcto de UUID o el producto ya existe en la base de datos.' })
  @ApiResponse({ status: 401, description: 'Token invalido, no autorizado.' })
